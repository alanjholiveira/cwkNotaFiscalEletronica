...
{
    class NotaFiscalEletronica50a : INotaFiscalEletronica
    {
        private string obs;
        ...
        public NotaFiscalEletronica50a(TipoEmissao _tipoServidor, cwkAmbiente _ambiente, TipoDoCertificado _tipoCertificado, string _diretorioPadrao,
        ...
        private void DadosNFe(FinalidadeNFe finalidadeNFe)
        {
            ...
            SpdNFeDataSetX.SetCampo(("versao_A02=3.10")); //Versão do Layout que está utilizando
        ...
        private void DadosTotalizadores(IList<INotaItem> notaItems, decimal totalProduto, decimal totalNota)
        {
            ...
            //Incluso 3 novos campos no grupo de  Total da Nota Fiscal 
...
#pragma warning restore CS0168 // A variável "e" está declarada, mas nunca é usada
        ...
        private void IniciarDataSet()
        {
            ...
            if (Nota.PessoaCidadeIBGE == "9999999")
            {
                this.SpdNFeDataSetX.DicionarioXML = @"Templates\vm50a\Conversor\NFeDataSets_Exportacao.xml";
            }
            else
            {
                this.SpdNFeDataSetX.DicionarioXML = @"Templates\vm50a\Conversor\NFeDataSets.xml";
            }
